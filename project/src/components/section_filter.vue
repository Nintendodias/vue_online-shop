		...
		<form class="filter__form form" action="#" method="get">
			<fieldset class="form__block">
				...
				<label class="form__label form__label--price">
					<input class="form__input" type="text" name="min-price" v-model='currentPriceMin' value="0" />
					<span class="form__value">От</span>
				</label>
				<label class="form__label form__label--price">
					<input class="form__input" type="text" name="max-price" v-model='priceMax' value="12345" />
